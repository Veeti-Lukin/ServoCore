...
inline size_t sizeOfCppTypeByParameterValueType(ParameterValueType type) {
    switch (type) {
        ...
        case ParameterValueType::uint32:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::uint32>::type);
        case ParameterValueType::uint64:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::uint64>::type);
        case ParameterValueType::int8:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::int8>::type);
        case ParameterValueType::int16:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::int16>::type);
        case ParameterValueType::int32:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::int32>::type);
        case ParameterValueType::int64:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::int64>::type);
        case ParameterValueType::floating_point:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::floating_point>::type);
        case ParameterValueType::double_float:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::double_float>::type);
        case ParameterValueType::boolean:
            return sizeof(MapParameterValueTypeToCppType<ParameterValueType::boolean>::type);
