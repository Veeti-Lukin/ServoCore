...
|-----------|------------|----------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------|
| CMake     | \>= 3.20   | [cmake.org/download](https://cmake.org/download/) - **pick one that matches your host platform**                     | Tick **Add CMake to the system PATH** in the installer. Check with `cmake --version`.                   |
