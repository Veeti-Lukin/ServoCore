// HOST TEST STUB: verbatim copy of pico-sdk src/rp2350/hardware_regs/include/hardware/regs/usb.h
// with the _u() helper it expects. Regenerate from the SDK if the pin changes.
#ifndef _u
#define _u(x) x##u
#endif
